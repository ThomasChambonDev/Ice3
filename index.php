...
<body>
	...
	<section id="outils_partage">
		...
		<fb:like href="http://www.facebook.com/pages/Le-jeu-le-plus-givr%C3%A9-de-lann%C3%A9e/219069664799259" send="false" layout="box_count" width="75" show_faces="false" font="verdana"></fb:like>
	...
	<section id="cadre_droite">
		...
		<div id="bloc_social">
			...
			<div class="likebox">
				<div id="test" class="fb-like-box" data-href="http://www.facebook.com/pages/Le-jeu-le-plus-givr%C3%A9-de-lann%C3%A9e/219069664799259" data-width="240" data-height="500" data-show-faces="true" data-stream="false" data-header="true"></div>
			</div>
		</div>
	</section>
			...
			<section id="contenu_bas">
				...
				<section id="contenu_boite">
					...
					<ul class="contenu_boite">
						<li>
							<p>- 5 supports à glaçon de couleur (gobelet + porte-glaçon)<img class="contenu_gobelet" alt="Gobelet glaçon Ice3" src="img/gobelet.png"/>x5</p>
						</li>
						<li>
							<p>- 2 pipettes de 3ml <img class="contenu_pipette" alt="Pipette Ice3" src="img/pipette.png"/>x2</p>
						</li>
						<li>
							<p>- Une cuillère</p>
						</li>
						...
						<ul class="decomposition_cartes">
							<li><p>- 6 cartes "Memo"</p></li>
							<li><p>- 1 carte "Verre" pour le départ</p></li>
							<li><p>- 1 carte "Bac à glaçons" pour l'arrivée</p></li>
							<li><p>- 44 cartes "Mouvement"</p></li>
							<li><p>- 28 cartes "Attaque"</p></li>
							<li><p>- 28 cartes "Défense"</p></li>
						</ul>
					</ul>
